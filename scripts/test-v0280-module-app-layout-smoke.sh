...
cpp_stub="$project/flowrt/app/stubs/mygo_lidar/cpp/src/driver.cpp"
...
run grep -F '"user_file_path": "app/mygo_lidar/cpp/src/driver.cpp"' "$app_api"
run grep -F '"path": "app/stubs/mygo_lidar/rust/calibrator.rs"' "$app_api"
run grep -F '"path": "app/stubs/mygo_lidar/cpp/src/driver.cpp"' "$app_api"
...
run grep -F 'user file: `app/mygo_lidar/cpp/src/driver.cpp`' "$implementation"
run grep -F 'reference stub: `app/stubs/mygo_lidar/cpp/src/driver.cpp`' "$implementation"
