...
printf '\n[5/14] v0.5.0 focused CI gate 覆盖\n'
...
printf '\n[6/14] v0.6.0 focused CI gate 覆盖\n'
...
printf '\n[7/14] v0.7.0 focused CI gate 覆盖\n'
...
printf '\n[8/14] v0.8.0 focused CI gate 覆盖\n'
...
printf '\n[9/14] v0.8.1 focused CI gate 覆盖\n'
...
printf '\n[10/14] v0.8.3 交叉编译 focused CI gate 覆盖\n'
...
printf '\n[11/14] v0.8.6 交叉 UX focused CI gate 覆盖\n'
...
printf '\n[12/14] v0.9.0 Island focused CI gate 覆盖\n'
