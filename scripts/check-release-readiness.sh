...
printf '\n[5/27] v0.5.0 focused CI gate 覆盖\n'
...
printf '\n[6/27] v0.6.0 focused CI gate 覆盖\n'
...
printf '\n[7/27] v0.7.0 focused CI gate 覆盖\n'
...
printf '\n[8/27] v0.8.0 focused CI gate 覆盖\n'
...
printf '\n[9/27] v0.8.1 focused CI gate 覆盖\n'
...
printf '\n[10/27] v0.8.3 交叉编译 focused CI gate 覆盖\n'
...
printf '\n[11/27] v0.8.6 交叉 UX focused CI gate 覆盖\n'
...
printf '\n[12/27] v0.9.0 Island focused CI gate 覆盖\n'
...
printf '\n[13/27] v0.9.1 Island tooling focused CI gate 覆盖\n'
...
printf '\n[14/27] v0.9.2 Island offline validation focused CI gate 覆盖\n'
...
printf '\n[15/27] v0.10.2 Concurrency focused CI gate 覆盖\n'
...
printf '\n[16/27] v0.12.0 Authoring focused CI gate 覆盖\n'
...
printf '\n[17/27] v0.13.0 Robot Runtime Completion focused CI gate 覆盖\n'
...
printf '\n[18/27] v0.14.0 Realtime Scheduler focused CI gate 覆盖\n'
...
printf '\n[19/27] v0.14.1 Architecture focused CI gate 覆盖\n'
...
printf '\n[20/27] v0.15.x focused CI gate 覆盖\n'
...
printf '\n[21/27] v0.23.2 C++ clang-tidy focused CI gate 覆盖\n'
...
printf '\n[22/27] v0.23.3 focused CI gate 覆盖\n'
...
# ── 26. Release evidence 门禁覆盖 ─────────────────────────

printf '\n[26/27] Release evidence 门禁覆盖\n'
