...
#   18. README 安装示例版本是否与发布版本一致
#   19. CONTEXT 当前 workspace 版本是否与发布版本一致
#   20. tag 状态提示
#
...
printf '\n[5/20] v0.5.0 focused CI gate 覆盖\n'
...
printf '\n[6/20] v0.6.0 focused CI gate 覆盖\n'
...
printf '\n[7/20] v0.7.0 focused CI gate 覆盖\n'
...
printf '\n[8/20] v0.8.0 focused CI gate 覆盖\n'
...
printf '\n[9/20] v0.8.1 focused CI gate 覆盖\n'
...
printf '\n[10/20] v0.8.3 交叉编译 focused CI gate 覆盖\n'
...
printf '\n[11/20] v0.8.6 交叉 UX focused CI gate 覆盖\n'
...
printf '\n[12/20] v0.9.0 Island focused CI gate 覆盖\n'
...
printf '\n[13/20] v0.9.1 Island tooling focused CI gate 覆盖\n'
...
printf '\n[14/20] v0.9.2 Island offline validation focused CI gate 覆盖\n'
...
printf '\n[15/20] v0.10.2 Concurrency focused CI gate 覆盖\n'
...
printf '\n[16/20] v0.12.0 Authoring focused CI gate 覆盖\n'
...
printf '\n[17/20] v0.13.0 Robot Runtime Completion focused CI gate 覆盖\n'
...
printf '\n[19/20] CONTEXT.md 当前状态版本\n'

context_file="$repo_root/CONTEXT.md"
if [[ -f "$context_file" ]]; then
    context_version="$(first_match '(?<=当前 workspace 版本为 `)[0-9]+\.[0-9]+\.[0-9]+' "$context_file")"
