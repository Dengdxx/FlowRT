...
printf '\n[5/28] v0.5.0 focused CI gate 覆盖\n'
...
printf '\n[6/28] v0.6.0 focused CI gate 覆盖\n'
...
printf '\n[7/28] v0.7.0 focused CI gate 覆盖\n'
...
printf '\n[8/28] v0.8.0 focused CI gate 覆盖\n'
...
printf '\n[9/28] v0.8.1 focused CI gate 覆盖\n'
...
printf '\n[10/28] v0.8.3 交叉编译 focused CI gate 覆盖\n'
...
printf '\n[11/28] v0.8.6 交叉 UX focused CI gate 覆盖\n'
...
printf '\n[12/28] v0.9.0 Island focused CI gate 覆盖\n'
...
printf '\n[13/28] v0.9.1 Island tooling focused CI gate 覆盖\n'
...
printf '\n[14/28] v0.9.2 Island offline validation focused CI gate 覆盖\n'
...
printf '\n[15/28] v0.10.2 Concurrency focused CI gate 覆盖\n'
...
printf '\n[16/28] v0.12.0 Authoring focused CI gate 覆盖\n'
...
printf '\n[17/28] v0.13.0 Robot Runtime Completion focused CI gate 覆盖\n'
...
printf '\n[18/28] v0.14.0 Realtime Scheduler focused CI gate 覆盖\n'
...
printf '\n[19/28] v0.14.1 Architecture focused CI gate 覆盖\n'
...
printf '\n[20/28] v0.15.x focused CI gate 覆盖\n'
...
printf '\n[21/28] v0.23.2 C++ clang-tidy focused CI gate 覆盖\n'
...
printf '\n[22/28] v0.23.3 focused CI gate 覆盖\n'
...
printf '\n[23/28] v0.25.0 iox2 Service/Operation focused CI gate 覆盖\n'
...
# ── 27. Release evidence 门禁覆盖 ─────────────────────────

printf '\n[27/28] Release evidence 门禁覆盖\n'
