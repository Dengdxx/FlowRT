...
- package: `graph_health_stop_demo`
...
- reference stub: `app/stubs/rust/producer.rs`
- handlers:
  ...
  - `on_tick`: `fn on_tick(&mut self, sample: &mut flowrt::Output<Sample>) -> flowrt::Status`
...
- handlers:
  ...
  - `on_stop`: `fn on_stop(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_shutdown`: `fn on_shutdown(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_tick`: `fn on_tick(&mut self, sample: flowrt::Latest<'_, Sample>) -> flowrt::Status`
