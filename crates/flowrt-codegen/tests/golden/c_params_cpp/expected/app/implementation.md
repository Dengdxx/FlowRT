...
- language: `c`
- kind: `native`
- user file: `app/c/controller.c`
- reference stub: `app/stubs/c/controller.c`
- C callback header: `flowrt_app/c_components.h`
- C callback factory: `flowrt_app_controller_callbacks`
- handlers:
  ...
  - `on_tick`: `C task callback table entry`
  - `on_params_update`: `no generated C params handler yet`
  - `run_periodic`: `flowrt_status_t (*)(void*, const flowrt_c_component_context_t*, const flowrt_c_input_array_view_t*, flowrt_c_output_array_view_t*)`
