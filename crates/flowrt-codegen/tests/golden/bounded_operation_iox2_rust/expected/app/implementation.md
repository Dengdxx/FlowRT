...
- package: `bounded_operation_iox2_rust`
...
- handlers:
  ...
  - `on_tick`: `fn on_tick(&mut self, plan: &OperationClient_controller_plan) -> flowrt::Status`
...
- kind: `native`
- user file: `app/rust/mod.rs`
- reference stub: `app/stubs/rust/navigator.rs`
- handlers:
  - `on_init`: `fn on_init(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_start`: `fn on_start(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_stop`: `fn on_stop(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_shutdown`: `fn on_shutdown(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_tick`: `fn on_tick(&mut self) -> flowrt::Status`
  - `on_plan_operation`: `fn on_plan_operation(&mut self, goal: &PlanGoal, cancel: flowrt::OperationCancelToken, progress: &mut flowrt::OperationProgressPublisher<PlanFeedback>) -> flowrt::OperationHandlerResult<PlanResult>`
