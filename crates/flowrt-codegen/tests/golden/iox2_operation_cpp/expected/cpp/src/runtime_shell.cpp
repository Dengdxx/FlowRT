...
flowrt::Status App::run(const flowrt::Backend& backend, std::optional<std::size_t> run_ticks) {
    ...
    auto remote_operation_key_expr = flowrt::zenoh::operation_key_expr(
        "iox2_operation_cpp", flowrt_app::self_description_hash(), remote_operation_handshake.pid);
    ...
    if (status == flowrt::Status::Ok) {
        this->operation_client_controller_plan_.bind(
            flowrt::iox2::Iox2ServiceClient<flowrt::OperationStartRequest<PlanGoal>, flowrt::OperationStartAck>::open_shared("FlowRT/service/__flowrt_operation_controller_plan_start"),
        ...
        this->operation_start_server_navigator_plan_ = flowrt::iox2::Iox2ServiceServer<flowrt::OperationStartRequest<PlanGoal>, flowrt::OperationStartAck>::open("FlowRT/service/__flowrt_operation_controller_plan_start", 1U);
