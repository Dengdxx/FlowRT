...
const PACKAGE_NAME: &str = "feedback_loop_rust_demo";
...
pub struct App {
    ...
    bind_1: std::sync::Arc<std::sync::Mutex<flowrt::LatestChannel<State>>>,
...
impl App {
    ...
    fn step(
        ...
        let _ = tick_time_ms;
        {
            ...
            let state = __flowrt_bind_1_guard.view_at(tick_time_ms);
    ...
    pub fn run(self, backend: &dyn flowrt::Backend, run_ticks: Option<usize>) -> flowrt::Status {
        ...
        let _ = app.bind_1.lock().unwrap_or_else(|poisoned| poisoned.into_inner()).publish_at(State::default(), 0);
                    ...
                    let submitted = match admission.task {
                        flowrt::TaskId(1) => {
                            ...
                            let (__flowrt_input_state_value, __flowrt_input_state_stale, __flowrt_input_state_revision) = {
                                ...
                                let __flowrt_state_snapshot_view = __flowrt_bind_1_snapshot_guard.view_at(tick_time_ms);
