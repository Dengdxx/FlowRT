...
- reference stub: `app/stubs/rust/estimator.rs`
- handlers:
  ...
  - `on_tick`: `fn on_tick(&mut self, imu: flowrt::Latest<'_, Imu>, odom: &mut flowrt::Output<Odom>) -> flowrt::Status`
...
- kind: `native`
- user file: `app/rust/mod.rs`
- reference stub: `app/stubs/rust/imu_sim.rs`
- handlers:
  - `on_init`: `fn on_init(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_start`: `fn on_start(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_stop`: `fn on_stop(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
...
- kind: `native`
- user file: `app/rust/mod.rs`
- reference stub: `app/stubs/rust/monitor.rs`
- handlers:
  - `on_init`: `fn on_init(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_start`: `fn on_start(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_stop`: `fn on_stop(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_shutdown`: `fn on_shutdown(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_tick`: `fn on_tick(&mut self, imu: flowrt::Latest<'_, Imu>, odom: flowrt::Latest<'_, Odom>) -> flowrt::Status`
