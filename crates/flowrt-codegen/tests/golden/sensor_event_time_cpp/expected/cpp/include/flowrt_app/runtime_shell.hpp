...
private:
    ...
    std::unique_ptr<ConsumerInterface> consumer_;
    flowrt::BoundaryInput<ImuSample> boundary_input_sample_in_;
    flowrt::BoundaryOutput<ImuSample> boundary_output_echo_out_;
};
