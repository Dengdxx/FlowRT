...
pub struct OperationClient_controller_plan {
    pub(crate) start_client: std::sync::Arc<std::sync::OnceLock<flowrt::iox2::Iox2ServiceClient<flowrt::OperationStartRequest<PlanGoal>, flowrt::OperationStartAck>>>,
pub(crate) cancel_client: std::sync::Arc<std::sync::OnceLock<flowrt::iox2::Iox2ServiceClient<flowrt::OperationId, flowrt::OperationStatusSnapshot>>>,
pub(crate) status_client: std::sync::Arc<std::sync::OnceLock<flowrt::iox2::Iox2ServiceClient<flowrt::OperationId, flowrt::OperationStatusSnapshot>>>,
}
