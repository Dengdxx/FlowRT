...
private:
    ...
    FlowrtTaskOutcome step_process_main_task_controller_main(std::size_t tick, flowrt::Context& tick_context, flowrt::IntrospectionState& introspection_state, flowrt::ScheduleWaiter& scheduler_events, std::map<std::string, flowrt::IntrospectionTaskHealth>& health_map);
    FlowrtTaskOutcome step_process_main_task_plant_main(std::size_t tick, flowrt::Context& tick_context, flowrt::IntrospectionState& introspection_state, flowrt::ScheduleWaiter& scheduler_events, std::map<std::string, flowrt::IntrospectionTaskHealth>& health_map);
    ...
    flowrt::LatestChannel<Cmd> bind_0_;
    flowrt::IntrospectionChannelProbe introspection_probe_bind_0;
    flowrt::LatestChannel<State> bind_1_;
