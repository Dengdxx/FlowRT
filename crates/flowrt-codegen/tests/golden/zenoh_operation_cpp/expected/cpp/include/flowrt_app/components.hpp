...
/**
 * @brief `controller.plan` Operation client（zenoh backend）。
 *
 * `slot_` 在所属进程启动时由 runtime shell 经 `bind()` 填充内部 zenoh service clients；
...
public:
    ...
    void bind(
        flowrt::zenoh::ZenohServiceClient<flowrt::OperationStartRequest<PlanGoal>, flowrt::OperationStartAck> start_client,
        flowrt::zenoh::ZenohServiceClient<flowrt::OperationId, flowrt::OperationStatusSnapshot> cancel_client,
        flowrt::zenoh::ZenohServiceClient<flowrt::OperationId, flowrt::OperationStatusSnapshot> status_client) {
        if (slot_) {
...
private:
    struct Slot {
        std::optional<flowrt::zenoh::ZenohServiceClient<flowrt::OperationStartRequest<PlanGoal>, flowrt::OperationStartAck>> start_client;
        std::optional<flowrt::zenoh::ZenohServiceClient<flowrt::OperationId, flowrt::OperationStatusSnapshot>> cancel_client;
        std::optional<flowrt::zenoh::ZenohServiceClient<flowrt::OperationId, flowrt::OperationStatusSnapshot>> status_client;
    };
