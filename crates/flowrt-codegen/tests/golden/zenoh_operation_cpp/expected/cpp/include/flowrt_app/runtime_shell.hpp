...
private:
    ...
    std::optional<flowrt::zenoh::ZenohServiceServer<flowrt::OperationStartRequest<PlanGoal>, flowrt::OperationStartAck>> operation_start_server_navigator_plan_;
    std::optional<flowrt::zenoh::ZenohServiceServer<flowrt::OperationId, flowrt::OperationStatusSnapshot>> operation_cancel_server_navigator_plan_;
    std::optional<flowrt::zenoh::ZenohServiceServer<flowrt::OperationId, flowrt::OperationStatusSnapshot>> operation_status_server_navigator_plan_;
