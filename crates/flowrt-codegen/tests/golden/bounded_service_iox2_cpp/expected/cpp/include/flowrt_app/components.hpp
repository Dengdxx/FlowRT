...
public:
    ...
    void bind(flowrt::iox2::Iox2FrameServiceClient<PlanRequest, PlanResponse, 44, 21> client) {
        if (slot_) {
...
private:
    struct Slot {
        std::optional<flowrt::iox2::Iox2FrameServiceClient<PlanRequest, PlanResponse, 44, 21>> client;
    };
