...
- reference stub: `app/stubs/rust/fusion.rs`
- handlers:
  ...
  - `on_tick`: `fn on_tick(&mut self, imu: flowrt::Latest<'_, Imu>, odom: flowrt::Latest<'_, Odom>, estimate: &mut flowrt::Output<Estimate>) -> flowrt::Status`
...
- kind: `native`
- user file: `app/rust/mod.rs`
- reference stub: `app/stubs/rust/imu_src.rs`
- handlers:
  - `on_init`: `fn on_init(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_start`: `fn on_start(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_stop`: `fn on_stop(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_shutdown`: `fn on_shutdown(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_tick`: `fn on_tick(&mut self, imu: &mut flowrt::Output<Imu>) -> flowrt::Status`
...
- kind: `native`
- user file: `app/rust/mod.rs`
- reference stub: `app/stubs/rust/odom_src.rs`
- handlers:
  - `on_init`: `fn on_init(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_start`: `fn on_start(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_stop`: `fn on_stop(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_shutdown`: `fn on_shutdown(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_tick`: `fn on_tick(&mut self, odom: &mut flowrt::Output<Odom>) -> flowrt::Status`
...
- kind: `native`
- user file: `app/rust/mod.rs`
- reference stub: `app/stubs/rust/sink.rs`
- handlers:
  - `on_init`: `fn on_init(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_start`: `fn on_start(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_stop`: `fn on_stop(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_shutdown`: `fn on_shutdown(&mut self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_tick`: `fn on_tick(&mut self, estimate: flowrt::Latest<'_, Estimate>) -> flowrt::Status`
