...
- reference stub: `app/stubs/cpp/producer.cpp`
- handlers:
  ...
  - `on_tick`: `flowrt::Status on_tick(flowrt::Output<Sample>& sample)`
...
- handlers:
  ...
  - `on_stop`: `flowrt::Status on_stop(flowrt::Context& context)`
  - `on_shutdown`: `flowrt::Status on_shutdown(flowrt::Context& context)`
  - `on_tick`: `flowrt::Status on_tick(const flowrt::Latest<Sample>& sample)`
