...
- package: `island_sensor_rust_demo`
...
- reference stub: `app/stubs/rust/consumer.rs`
- handlers:
  ...
  - `on_tick`: `fn on_tick(&mut self, sample: flowrt::Latest<'_, ImuSample>, echo: &mut flowrt::Output<ImuSample>) -> flowrt::Status`
