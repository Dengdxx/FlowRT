...
impl flowrt_app::components::Consumer for Consumer {
    fn on_tick(
        &mut self,
        sample: flowrt::Latest<'_, flowrt_app::messages::ImuSample>,
        echo: &mut flowrt::Output<flowrt_app::messages::ImuSample>,
    ) -> flowrt::Status {
        let _ = sample;
        echo.write(flowrt_app::messages::ImuSample::default());
        flowrt::Status::Ok
    }
}
