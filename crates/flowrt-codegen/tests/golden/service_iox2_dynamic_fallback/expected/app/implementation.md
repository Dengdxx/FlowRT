...
- package: `service_iox2_dynamic_fallback`
- graph: `default` mode=`strict` profile=`default` backend=`iox2`
...
- reference stub: `app/stubs/rust/plan_service.rs`
- handlers:
  - `on_init`: `fn on_init(&self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_start`: `fn on_start(&self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_stop`: `fn on_stop(&self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_shutdown`: `fn on_shutdown(&self, context: &mut flowrt::Context) -> flowrt::Status`
  - `on_tick`: `fn on_tick(&self) -> flowrt::Status`
  - `on_plan_request`: `fn on_plan_request(&self, request: &PlanRequest) -> flowrt::ServiceResult<PlanResponse>`
...
- kind: `native`
- user file: `app/rust/mod.rs`
- reference stub: `app/stubs/rust/planner.rs`
- handlers:
  ...
  - `on_tick`: `fn on_tick(&mut self, plan: &ServiceClient_planner_plan) -> flowrt::Status`
