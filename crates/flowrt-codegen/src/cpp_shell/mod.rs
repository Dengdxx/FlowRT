...
pub(crate) fn emit_cpp_runtime_shell(contract: &ContractIr) -> String {
    ...
    for plan in &operation_plans {
        ...
        let owner_scope = operation_name.clone();
        let owner_name =
