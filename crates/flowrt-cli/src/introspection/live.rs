            ...
            Ok(flowrt::IntrospectionResponse::Status { handshake, status }) => {
                ...
                for route in &status.routes {
                    let static_thread_affinity = static_facts
                        ...
                        .unwrap_or("none");
                    lines.push(format!(
                        "route={} from={} to={} type={} backend={} thread_affinity={} static_thread_affinity={} selected_reason={} published_count={} dropped_samples={} backpressure={} overflow={} last_publish_ms={} last_error={} last_error_kind={} backend_health={} backend_recoverable={} backend_reconnect_attempt={} backend_next_retry_unix_ms={} backend_health_error={} socket={}",
                        route.name,
                        route.from,
                        route.to,
                        route.message_type,
                        ...
                        option_str(route.last_error_kind.as_deref()),
