...
fixed-size plain data message，并可把 primitive/array/table params 作为 callback context 中的
readonly snapshot 暴露；service、operation、variable frame、`io_boundary` 和 `external`
不在 C v0 用户入口范围内。
