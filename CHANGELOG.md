...
- `v0.5.0` 规划 launch-grade supervisor、参数控制面和高频调度硬化：补齐条件启动、错峰启动、环境变量、restart policy、CPU affinity、profile、参数发现/远程控制面，以及多 lane 调度的 deadline、stale、backpressure 和 fairness 语义。
