...
- App API manifest、`implementation.md` 和 reference stubs 现在按 workspace module 暴露用户侧
  组织路径：module component 使用 `app/<module>/<lang>/<component>.*`，对应参考 stub 生成到
  `flowrt/app/stubs/<module>/<lang>/<component>.*`；root component 保持既有 `app/rust/mod.rs`、
  `app/cpp/**` 和 `app/c/**` 路径。

### 变更

- generated CMake 的 C/C++ 用户代码自动发现范围扩展到 `app/<module>/cpp/**` 和
  `app/<module>/c/**`，便于同一 RSDL module 内按 component 拆分 C++/C 用户实现；Rust 仍由
