...
int main() {
    ...
    static_assert(FLOWRT_OPERATION_STATE_ACCEPTED == 0U);
    static_assert(FLOWRT_OPERATION_STATE_RUNNING == 1U);
    static_assert(FLOWRT_OPERATION_STATE_CANCELING == 2U);
    static_assert(FLOWRT_OPERATION_STATE_SUCCEEDED == 3U);
    static_assert(FLOWRT_OPERATION_STATE_FAILED == 4U);
    static_assert(FLOWRT_OPERATION_STATE_CANCELED == 5U);
    static_assert(FLOWRT_OPERATION_STATE_TIMEOUT == 6U);
    static_assert(FLOWRT_OPERATION_STATE_PREEMPTED == 7U);
